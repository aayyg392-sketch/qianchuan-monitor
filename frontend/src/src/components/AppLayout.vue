...
const openSubMenus = ref({ '/live': true, '/materials': true, '/campaigns': true, '/audience': true, '/industry': true, '/operations': true, '/ks-ops': true })
...
const navItems = [
  ...
  { path: '/wx-ops', label: '视频号运营中心', icon: operationIcon, children: [
    ...
    { path: '/ks-ad-comments', label: '素材评论' },
  ]},
...
const allNavItems = [
  ...
  { path: '/ks-ad-comments', label: '素材评论', icon: operationIcon },
  { path: '/reports', label: '数据分析', icon: chartIcon },
  { path: '/alerts', label: '告警中心', icon: bellIcon, badge: true },
...
const pageMap = {
  ...
  '/ks-reviews': '评价管理', '/ks-ad-comments': '素材评论',
