        ...
        <a-tab-pane key="wx_channels" tab="视频号助手配置">
          <a-spin :spinning="settingsLoading">
            <div style="max-width: 480px">
              ...
              <a-button type="primary" @click="saveWxChannels" :loading="settingsLoading">保存配置</a-button>
              <div style="margin-top: 12px; color: #8c8c8c; font-size: 12px">
                <span>💡 视频号助手API用于橱窗管理、达人罗盘数据。在视频号助手后台 → 开放能力获取。</span>
              </div>
            </div>
          </a-spin>
        </a-tab-pane>
        <a-tab-pane key="wx_shop" tab="微信小店配置">
          <a-spin :spinning="settingsLoading">
            <div style="max-width: 480px">
              ...
              <a-button type="primary" @click="saveWxShop" :loading="settingsLoading">保存配置</a-button>
              <div style="margin-top: 12px; color: #8c8c8c; font-size: 12px">
                <span>💡 微信小店API用于电商罗盘、订单管理、商品管理。在微信小店后台 → 开放能力获取。</span>
              </div>
            </div>
          </a-spin>
        </a-tab-pane>
