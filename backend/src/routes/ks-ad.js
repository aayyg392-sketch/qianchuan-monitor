...
router.get('/oauth-url', async (req, res) => {
  try {
    ...
    const scope = ['ad_query', 'ad_manage', 'report_service', 'account_service', 'fund_service', 'esp_ad_query', 'esp_ad_manage', 'esp_report_service', 'esp_account_service', 'esp_fund_service', 'public_dmp_service', 'public_agent_service', 'public_account_service'];
