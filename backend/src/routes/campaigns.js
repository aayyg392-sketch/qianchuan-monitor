...
router.get('/overview', auth(), async (req, res) => {
  ...
  try {
    ...
    const cards = [
      ...
      { key: 'avg_price',  label: '整体成交单价',   value: avgPrice,        change: pct(avgPrice, yAvgPrice),     prefix: '¥', trend: trendRows.map(r => { const o = parseInt(r.orders)||1; return (parseFloat(r.gmv)||0)/o; }) },
      ...
      { key: 'ord_1k',     label: '千元成交单数',   value: ordPer1k,        change: pct(ordPer1k, yOrdPer1k),     prefix: '',  trend: trendRows.map(r => { const c = parseFloat(r.cost)||1; return (parseInt(r.orders)||0)*1000/c; }) },
    ];
